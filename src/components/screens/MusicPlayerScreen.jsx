...
const MusicPlayerScreen = () => {
  ...
  const { 
    title = "Now Playing", 
    audioSrc = "/breath-of-life_10-minutes.mp3"  
  } = location.state || {};
  ...
  return (
    <div className="h-screen flex flex-col items-center justify-center bg-[#1F265E] text-center text-white">
      ...
      {/* Title */}
      <h2 className="text-2xl font-bold text-white">Night Island</h2>
      <p className="text-sm text-gray-300 font-semibold">Sleep Music</p>
      ...
      {/* Hide current audio source */}
      {/* <p className="mt-4 text-gray-200">Playing: {audioSrc}</p> */}
    </div>     
  );
};
